...
const skills = [
  ...
  {name: "NestJS", level: 90, category: "frameworks"},
  ...
  {name: "Prisma", level: 80, category: "databases"},
  ...
  // Architecture
  {name: "DDD Architecture", level: 85, category: "architectures"},
  {name: "Clean Architecture", level: 85, category: "architectures"},
  {
    name: "Modular Monolith",
    level: 85,
    category: "architectures",
  },
  {name: "Microservices", level: 80, category: "architectures"},
];
